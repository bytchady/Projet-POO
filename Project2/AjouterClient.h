...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->bModifierAdresse->Text = L"Ajouter adresse";
			this->bModifierAdresse->UseVisualStyleBackColor = true;
			this->bModifierAdresse->Click += gcnew System::EventHandler(this, &AjouterClient::bAjouterAdresse_Click);
			// 
			// tableLayoutPanel3
			// 
...
#pragma endregion
	...
	private: System::Void bAjouterAdresse_Click(System::Object^ sender, System::EventArgs^ e) {
		AjouterAdresse^ a = gcnew AjouterAdresse();
		a->ShowDialog();
	}
