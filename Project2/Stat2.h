...
namespace ProjectPOO {
	...
	/// <summary>
	/// Description résumée de Stat2
	/// </summary>
	public ref class Stat2 : public System::Windows::Forms::Form
	{
	public:
		Stat2(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->bRetour->Click += gcnew System::EventHandler(this, &Stat2::bRetour_Click);
			// 
			// label1
			// 
			...
			this->label1->Text = L"Liste des 10 articles les moins vendus";
			// 
			// dataGridView1
			// 
