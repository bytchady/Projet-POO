...
namespace ProjectPOO {
	...
	/// <summary>
	/// Description résumée de Stat1
	/// </summary>
	public ref class Stat1 : public System::Windows::Forms::Form
	{
	public:
		Stat1(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->bRetour->Click += gcnew System::EventHandler(this, &Stat1::bRetour_Click);
			// 
			// label1
			// 
			...
			this->label1->Text = L"Liste des 10 articles les plus vendus";
			// 
			// dataGridView1
			// 
