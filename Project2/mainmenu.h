...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->tabmenu->Location = System::Drawing::Point(471, 106);
			this->tabmenu->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
...
#pragma endregion
	...
	private: System::Void bCommandes_Click(System::Object^ sender, System::EventArgs^ e) {
		HistoriqueCommande^ hc = gcnew HistoriqueCommande();
		hc->ShowDialog();
	}
